...
"""
def getEk_Hall(vx,vy,vz,rho,p,gamma,bi,bj,bk,bx,by,bz,
          d_min,NO2,PDMB,CA,limiter_type='PDM'):
    """
    ...
    Requries:
        ...
        CA - Speed of light in Borris correction
...
###########################################################################
    ...
    # step 5:  with Whistler resistivity, the eta*j
    ...
    Valfvn = n.sqrt(bx**2+by**2+bz**2)
    Va_eff = Valfvn*CA/n.sqrt(Valfvn**2+CA**2)
    VF = 2*n.pi/(2*d_min)*Va_eff**2
    etak = 0.25*(
